...
const images = [
  {
    src: '/Hospital-image/hero1.jpeg',
    alt: 'CurePlus Multispeciality Hospital building in Mysore',
  },
  {
    src: '/Hospital-image/Hero3.jpeg',
    alt: 'Advanced healthcare services at CurePlus Hospitals',
  },
];
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="CurePlus Hospitals offers advanced multispeciality healthcare, emergency services, diagnostics, and expert doctors across Mysore & Karnataka."
        />
        ...
        <div className="relative z-20 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-white max-w-xl mx-auto lg:mx-0 mb-8">
              We deliver compassionate, technology-driven healthcare solutions
              that prioritize patients at every step. Your well-being is our
              mission - today and always.
            </p>
