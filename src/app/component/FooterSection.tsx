  ...
  <footer className="bg-footerbackground text-gray-100 py-12">
    <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10">
      ...
      <div>
        ...
        <p>
          Delivering accessible healthcare across Karnataka with 19+ hospitals,
      ...
      <div>
        ...
        <div className="space-y-4">
          <p className="flex items-center gap-3">
            ...
            <a href="tel:+919035193777" className="text-white">+91 90351 93777</a>
          </p>
          <p className="flex items-center gap-3">
            <FaEnvelope className="text-white" /> info@cureplushospitals.com
          </p>
          <p className="flex items-center gap-3">
