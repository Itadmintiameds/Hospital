...
const HospitalsPage = () => {
  const hospitals = [
    ...
    { id: 14, name: 'CurePlus Hospital Arakere', image: '/hospital/arakere.jpeg' ,phone:'+9182363253703' },
    { id: 15, name: 'CurePlus Hospital Huliyurudurga', image: '/hospital/huliyurudurga.jpeg' ,phone:'' },
